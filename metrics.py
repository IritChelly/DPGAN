...
run = neptune.init(
    project="itohamy/AE-clustering-dpgan",
    tags="metrics",
...
datasets = ['imagenet', 'cifar', 'stacked_mnist', 'places', 'mnist']
            ...
            for checkpoint in checkpoint_files:
                if (checkpoint.endswith('.pt') and checkpoint != 'model.pt') or checkpoint == 'pretrained':
                    ...
                    if args.modes and (it not in kl_results or it not in nmodes_results):
                        ...
                        run['results/metrics/kl/'].upload(os.path.join(results_dir, 'kl_results.json'))
                        run['results/metrics/nmodes/'].upload(os.path.join(results_dir, 'nmodes_results.json'))
